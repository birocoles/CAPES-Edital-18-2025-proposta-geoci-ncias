...
\begin{titlepage}
	\begin{center}
		...
		\LARGE
		\textbf{Proposta de atuação frente à área de Geociências}
		...
		\begin{minipage}{.5\textwidth}
			\vspace{3.0cm}
			\normalsize
			Documento desenvolvido no âmbito do Edital CAPES n$^\circ$18/2025 como parte
			dos requisitos para candidatura ao exercício da coordenação da área
			de Geociências no período de 2026 a 2023.
		\end{minipage}%
		\vspace*{\fill}
