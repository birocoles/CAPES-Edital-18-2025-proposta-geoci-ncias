...
\begin{titlepage}
	\begin{center}
		...
		\LARGE
		\textbf{Reflexões e propostas de atuação frente à área de Geociências}
		...
		\begin{minipage}{.5\textwidth}
			\vspace{3.0cm}
			\normalsize
			Documento desenvolvido no âmbito do Edital CAPES n$^\circ$18/2025 com o 
			intuito de contribuir com candidaturas ao exercício da coordenação da área
			de Geociências no período de 2026 a 2030.
		\end{minipage}%
		\vspace*{\fill}
...
\include{CAPES-areas-avaliacao}
\include{geociencias-brasil}
\include{competicao-colaboracao}
\include{possiveis-estrategias}
